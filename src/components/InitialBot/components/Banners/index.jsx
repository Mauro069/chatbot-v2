  ...
  return (
    <div className={styles.banners_container}>
      {banners.map((banner, index) => {
        ...
        const bannerDescriptionContainerClass = `${styles.banner_description_container} ${isDark ? styles.dark : ''}`;
        const bannerDescriptionTypeClass = `${styles.banner_description_type} ${isDark ? styles.dark : ''}`;
        ...
        return (
          ...
          >
            ...
            <div className={bannerDescriptionContainerClass}>
              ...
              <p className={bannerDescriptionTypeClass}>
                {banner.type}
              </p>
            </div>
          </div>
